...
public class OnTouchFrame {
    ...
    public OnTouchFrame(Frame frame) {
        this(frame,0.1875f,1.0f,0.375f);
    }

    public OnTouchFrame(Frame frame, float colorR, float colorG, float colorB) {
        mDrawLock = true;
        color = new float[4];
        color[0] = colorR;
        color[1] = colorG;
